...
NOT for: PRD creation or product strategy ÔåÆ Use @pm. Technical architecture decisions or technology selection ÔåÆ Use @architect. Story creation or sprint planning ÔåÆ Use @sm.
'
tools: ['read', 'edit', 'search', 'execute']
---

# ­ƒöì Atlas Agent (@analyst)
