...
NOT for: Market research or competitive analysis ÔåÆ Use @analyst. PRD creation or product strategy ÔåÆ Use @pm. Database schema design or query optimization ÔåÆ Use @data-engineer.
'
tools: ['read', 'edit', 'search', 'execute']
---

# ­ƒÅø´©Å Aria Agent (@architect)
