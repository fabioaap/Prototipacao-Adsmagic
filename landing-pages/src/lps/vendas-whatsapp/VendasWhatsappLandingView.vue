          ...
          <article class="home-lp__testimonial-card" v-reveal="{ type: 'scale' }">
            ...
            <div class="home-lp__testimonial-author">
              <img
                ...
                :src="publicAsset(`img/landing/home/${homeLandingTestimonial.avatar}`)"
        ...
        <div class="home-lp__faq-inner">
          <div class="home-lp__faq-layout">
            ...
            <div class="home-lp__faq-list" v-reveal="{ type: 'fadeRight' }">
              ...
              >
                <button
                  :id="`home-faq-trigger-${faq.id}`"
                  type="button"
                  class="home-lp__faq-trigger"
                  :aria-expanded="openFaqId === faq.id"
                  :aria-controls="`home-faq-panel-${faq.id}`"
                ...
                <div
                  :id="`home-faq-panel-${faq.id}`"
                  class="home-lp__faq-answer"
                  :class="{ 'is-hidden': openFaqId !== faq.id }"
                  role="region"
                  :aria-labelledby="`home-faq-trigger-${faq.id}`"
...
.home-lp__faq-answer.is-hidden {
  grid-template-rows: 0fr;
  opacity: 0;
  padding-bottom: 0;
}

.home-lp__faq-answer > p {
  overflow: hidden;
  margin: 0;
  font-size: 16px;
  line-height: 1.5;
