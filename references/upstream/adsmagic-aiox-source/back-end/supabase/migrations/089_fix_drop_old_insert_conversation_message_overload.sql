-- ============================================================================
-- Migration 089: Fix - Dropar overload antigo de insert_conversation_message
--
-- Existem DUAS funcoes com o mesmo nome (18 e 19 params).
-- PostgREST nao consegue resolver a ambiguidade ao chamar via .rpc(),
-- causando falha silenciosa na persistencia de mensagens.
-- ============================================================================

-- Drop da funcao ANTIGA (18 params, sem p_quoted_message_id)
DROP FUNCTION IF EXISTS insert_conversation_message(
  uuid, uuid, uuid, text, text, text, text, text, text, text, text, text,
  double precision, double precision, text, text, jsonb, timestamptz
);

-- Re-criar a funcao CORRETA (19 params) de forma idempotente
