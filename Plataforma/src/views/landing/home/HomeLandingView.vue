...
import { ArrowRight, Linkedin, Menu, Plus, X, Youtube } from 'lucide-vue-next'
import {
  homeLandingFaqs,
  homeLandingFeatures,
  homeLandingLinks,
  ...
  <div class="home-lp">
    ...
    <header :class="['home-lp__header', { 'is-stuck': headerStuck }]">
      <nav class="home-lp__nav">
        <a class="home-lp__brand" href="/lp/home" aria-label="Adsmagic home">
    ...
    <main>
      ...
      <section class="home-lp__hero">
        <div class="home-lp__hero-copy">
          <p class="home-lp__tagline">Venda mais pelo WhatsApp</p>
          <h1>Rastreie em tempo real a origem das conversas e aumente suas vendas.</h1>

          <p class="home-lp__hero-desc">Configure tudo em menos de 5 minutos. Integre WhatsApp com Google e Meta Ads gerando links rastreáveis em poucos cliques. Descubra de onde vêm suas melhores vendas e corte gasto em mídia desnecessário</p>
          ...
          <div class="home-lp__partners">
            <span class="home-lp__partners-label">Apoiado por</span>
            <div class="home-lp__partners-logos">
              <img
                v-for="partner in homeLandingSupportPartners"
                :key="partner.name"
                :src="`${base}img/landing/hero/${partner.logo}`"
                :alt="partner.name"
                class="home-lp__partner-logo"
              />
            </div>
          </div>
        </div>
        ...
        <aside class="home-lp__hero-visual">
          ...
          <img
              :src="`${base}img/landing/hero/hero-dashboard.png`"
      ...
      <section class="home-lp__flow-section">
        <div class="home-lp__flow-inner" v-reveal>
          ...
          <img
            :src="`${base}img/landing/home/flow-diagram.png`"
            ...
            >
              <div class="home-lp__feature-img-wrap">
                <img
                  ...
                  :src="`${base}img/landing/home/${feature.image}`"
        ...
        <div class="home-lp__pricing-inner">
          ...
          <div class="home-lp__pricing-grid" v-reveal="{ type: 'staggerChildren' }">
            <article
              ...
              :key="plan.id"
              :class="['home-lp__plan-card', { 'is-recommended': plan.recommended }]"
            >
              <span v-if="plan.recommended" class="home-lp__plan-badge">Recomendado</span>
              <span class="home-lp__plan-icon">{{ plan.icon }}</span>
              <h3 class="home-lp__plan-name">{{ plan.name }}</h3>
              <p class="home-lp__plan-desc">{{ plan.description }}</p>

              <p class="home-lp__plan-price">
                <span class="home-lp__plan-currency">R$</span>
                <span class="home-lp__plan-amount">{{ planPrice(plan) }}</span>
                <span class="home-lp__plan-period">/mês</span>
              </p>
              <p v-if="billingCycle === 'annual'" class="home-lp__plan-billing">Cobrado anualmente</p>
              <p v-else class="home-lp__plan-billing">Pago mensalmente</p>

              <ul class="home-lp__plan-features">
                <li v-for="feature in plan.features" :key="feature">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="8" fill="#3BB56D" opacity="0.15"/><path d="M5 8l2 2 4-4" stroke="#3BB56D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
                  {{ feature }}
                </li>
              </ul>
              ...
              <a
                :class="[
                  'home-lp__btn home-lp__btn--full',
                  plan.ctaStyle === 'filled' ? 'home-lp__btn--green' : 'home-lp__btn--outline-navy'
                ]"
                :href="plan.ctaStyle === 'filled' ? homeLandingLinks.signup : (plan.id === 'premium' ? homeLandingLinks.contact : homeLandingLinks.signup)"
                target="_blank"
                rel="noreferrer"
              >{{ plan.cta }}</a>
            </article>
      ...
      <section class="home-lp__testimonial-section">
        ...
        <div class="home-lp__testimonial-inner">
          <article class="home-lp__testimonial-card" v-reveal="{ type: 'scale' }">
            <svg class="home-lp__testimonial-quote-icon" viewBox="0 0 32 32" fill="none" aria-hidden="true">
            ...
            <p class="home-lp__testimonial-quote">
              &ldquo;{{ homeLandingTestimonial.quote }}&rdquo;
            </p>

            <div class="home-lp__testimonial-author">
              <img
                class="home-lp__testimonial-avatar"
                :src="`${base}img/landing/home/${homeLandingTestimonial.avatar}`"
                :alt="homeLandingTestimonial.name"
                loading="lazy"
              />
              <div>
                <p class="home-lp__testimonial-name">{{ homeLandingTestimonial.name }}</p>
                <p class="home-lp__testimonial-role">{{ homeLandingTestimonial.role }}</p>
              </div>
            </div>
          </article>
        </div>
            ...
            <div class="home-lp__faq-list" v-reveal="{ type: 'fadeRight' }">
              ...
              >
                ...
                <transition name="home-lp-faq">
                  <p v-if="openFaqId === faq.id" class="home-lp__faq-answer">{{ faq.answer }}</p>
                </transition>
              </article>
            </div>
          </div>
      ...
      <div class="home-lp__footer-inner">
        <div class="home-lp__footer-grid">
          <div class="home-lp__footer-left">
            <a class="home-lp__brand" href="/lp/home" aria-label="Adsmagic home">
              <img :src="`${base}logo-icon.svg`" alt="Adsmagic" class="home-lp__brand-icon" />
            </a>
