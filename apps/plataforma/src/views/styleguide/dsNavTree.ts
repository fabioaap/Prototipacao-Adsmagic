    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            id: 'brand-templates-ads-top5',
            title: 'Anúncios · Top 5 Tintim',
            slug: 'anuncios-top-5',
            description: 'Top 5 anúncios Meta modelados do Tintim — copy + criativo + Nano Banana.',
            tone: 'brand',
            status: 'live',
            pageId: 'brand-ads-top5',
          },
          {
            id: 'brand-templates-ads-top5-svg',
            title: 'Anúncios · SVG Text-Only',
            slug: 'anuncios-top-5-svg',
            description: 'Criativos SVG text-only (1:1 e 9:16) com fundo navy orgânico e tipografia editorial.',
            tone: 'brand',
            status: 'live',
            pageId: 'brand-ads-top5-svg',
          },
        ],
      },
      {
