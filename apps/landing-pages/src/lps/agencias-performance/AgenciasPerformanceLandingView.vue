  ...
  <div id="top" class="lp-root">
    ...
    <section class="lp-hero lp-hero--dark" :style="{ backgroundImage: `url('${publicAsset('img/landing/hero/hero-bg.png')}')` }">
      <div class="lp-container hero-shell">
        ...
        <BrandTrustRibbon class="hero-social-proof reveal-child" tone="dark" />
      </div>
    ...
    <section class="lp-section lp-section--alt">
      ...
      <div class="lp-container flex justify-center">
        <BrandTestimonialCard
          quote="Antes do Adsmagic eu perdia cerca de 2h por semana cruzando planilhas e ainda ficava no escuro sobre a origem das vendas. Hoje deixo o dashboard aberto o dia inteiro: em segundos sei qual canal trouxe cada pedido e realoco o orçamento na hora certa. Ganhei confiança nos números, parei de desperdiçar verba e consigo crescer novos canais com segurança."
          name="Gabriel Queiroz"
          role="Fundador da Melhor Limpeza"
          :avatar-src="testimonialAvatarSrc"
          avatar-alt="Gabriel Queiroz"
          size="compact"
        />
      </div>
    </section>
