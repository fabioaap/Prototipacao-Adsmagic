...
export const homeLandingLinks = {
  signup: landingPage.links.primaryCta,
  signupNav: landingPage.links.primaryNavCta ?? landingPage.links.primaryCta,
  login: landingPage.links.login,
  contact: landingPage.links.contact,
  privacy: landingPage.links.privacy,
  cookies: landingPage.links.cookies,
  terms: landingPage.links.terms,
}
